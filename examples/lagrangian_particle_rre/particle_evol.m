% Program inspired from Yann's programm
% particle_RRE_example.m
% to plot pressure, temperature and normalized specific volume evolution
...
function [ts_plot, Ps_plot, Ts, Vms_norm, ttl]= particle_evol(mode, x, y)
    if mode == 1
        H2_O2_to_He_conds;
    ...
    if r_0<0
        ...
        tsexp; %time spent in expansion fan
